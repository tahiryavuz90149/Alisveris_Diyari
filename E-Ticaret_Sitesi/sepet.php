...
$sepetQuery = $baglan->query("SELECT * FROM sepet
INNER JOIN kullanici ON kullanici.kullanici_id = sepet.kullanici_id
INNER JOIN urun ON sepet.urun_id = urun.urun_id
WHERE sepet.kullanici_id = $kullaniciId");
    ...
    <header class="main-header">
        ...
        <nav class="main-nav">
            <ul class="nav-ul">
                ...
                <li class="nav-ul-li"><a href="satici_anasayfa.php" >Geri Dön</a></li>
