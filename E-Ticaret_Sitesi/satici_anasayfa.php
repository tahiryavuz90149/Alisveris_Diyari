...
<body>
    <header class="main-header">
            ...
            <nav class="main-nav">
                <ul class="nav-ul">
                    ...
                    <li class="nav-ul-li"><a href="sepet.php?kullaniciId=<?php echo $kullaniciId ?>">Sepet</a></li> <!-- sepetin hangi kullanıcıya ait oldugunu belirlemek için id sini url adresinde gönderdik.-->
    ...
    <div>
                ...
                <?php
                    while($row = $kategoriler->fetch_assoc()){
                        ...
                        while($innerRow = $altKategori->fetch_assoc()){
                            echo '
                                <li class="menü-ul-li"><a href="kategoriler/kullanici-kategorileri/kul_'.$innerRow["altPath"].'" title="">'.$innerRow["ustKat"].'</a></li>';
                        }
                        echo '</ul>';
                        echo '</li>';
                    }
        ...
        <main class="Anakisim">
            ...
            <h5 style="text-align: center; margin-bottom: 2px;">Hoşgeldin <?php echo $kullaniciAdi?></h5>
            <h5 style="text-align: center; margin-bottom: 2px;"><b> <br> En Çok Tercih Edilen Ürünler</b></h5>
                ...
                <?php
                    ...
                    while($row = $urunler->fetch_assoc()){
                        ...
                        <div class="Anakisim-column">
                            ...
                            <a href="kullanici-ürün-detay.php?id='.$row["urun_id"].'">
