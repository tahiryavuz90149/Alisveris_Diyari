...
$defterler = $baglan->query("SELECT * FROM urun WHERE kategori = 'defter'");
?>
...
<body>
    ...
    <div>
        ...
        <main class="Anakisim">
            ...
            <h5 style="text-align: center; margin-bottom: 2px;"><b>Defterler</b></h5>
            
            <div class="Anakisim-favori-row">
                <?php

                    while($row = $defterler->fetch_assoc()){
