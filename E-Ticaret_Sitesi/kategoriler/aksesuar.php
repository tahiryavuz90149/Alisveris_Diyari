...
$aksesuarlar = $baglan->query("SELECT * FROM urun WHERE kategori = 'aksesuar'");
?>
...
<body>
    ...
    <div>
        ...
        <main class="Anakisim">
            ...
            <h5 style="text-align: center; margin-bottom: 2px;"><b>Aksesuarlar</b></h5>
            
            <div class="Anakisim-favori-row">
                <?php

                    while($row = $aksesuarlar->fetch_assoc()){
