<?php
    ...
    $televizyonlar = $baglan->query("SELECT * FROM urun WHERE kategori = 'televizyon'");
?>
...
<body>
    ...
    <div>
        ...
        <main class="Anakisim">
            ...
            <h5 style="text-align: center; margin-bottom: 2px;"><b>Televizyonlar</b></h5>
            
            <div class="Anakisim-favori-row">
                <?php

                    while($row = $televizyonlar->fetch_assoc()){
