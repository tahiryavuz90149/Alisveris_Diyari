...
$telefonlar = $baglan->query("SELECT * FROM urun WHERE kategori = 'telefon'");
...
<body>
    ...
    <div>
        ...
        <main class="Anakisim">
            ...
            <h5 style="text-align: center; margin-bottom: 2px;"><b>Telefonlar</b></h5>
            
            <div class="Anakisim-favori-row">
                <?php

                    while($row = $telefonlar->fetch_assoc()){
