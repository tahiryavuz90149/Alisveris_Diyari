...
$bilgisayarlar = $baglan->query("SELECT * FROM urun WHERE kategori = 'bilgisayar'");
?>
...
<body>
    ...
    <div>
        ...
        <main class="Anakisim">
            ...
            <h5 style="text-align: center; margin-bottom: 2px;"><b>Bilgisayarlar</b></h5>
            
            <div class="Anakisim-favori-row">
                <?php

                    while($row = $bilgisayarlar->fetch_assoc()){
